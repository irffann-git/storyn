...
function TrendingBooks() {
  ...
  const trendingBooks =
    books?.filter((book) => book.tags?.includes("Trending")).slice(0, 10) ?? [];
    ...
    <section className="py-16 bg-[#EDE4CB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-[#37400B]">Trending Books</h2>
          <Link
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 items-start">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/promo3.jpg')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            <Link to="/books?discount=30" className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-5xl sm:text-6xl font-black mt-4">30% OFF</h2>
