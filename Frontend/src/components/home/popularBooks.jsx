...
function PopularBooks() {
  ...
  const trendingBooks =
    books?.filter((book) => book.tags?.includes("Popular")).slice(0, 10) ?? [];
    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/collection/popular" className="text-sm font-semibold hover:text-orange-500">
            View All →
          </Link>
        </div>
...
>
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/promo5.jpg')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            <Link to={"/books?discount=50"}>
...
<div className="absolute inset-0 rounded-xl bg-gradient-to-b from-black/90 via-black/70 to-black/30" />
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-6xl font-black mt-4">50% OFF</h2>
